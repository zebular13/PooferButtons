...
//code to play Moopi's fire patterns
//const int tempo
...
const int pattern1[] = {
  ...
  //POP! Goes the weasel (plus surprise burst) 
  1, 1000, 
  2, 1000, 
  3, 1000, 
  4, 1000, 
...
void update_pattern() //runs in the loop
{
  if (whichPattern < numberOfPatterns) {
    ...
    int poofer = pattern[pattern_position];
    unsigned int duration = pattern[pattern_position + 1];
